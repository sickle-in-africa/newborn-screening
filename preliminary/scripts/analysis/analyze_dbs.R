...
write.csv(table_base, 'results/analysis/contingency-table-dbs.csv', row.names=FALSE)
write.csv(result, 'results/analysis/test-diagnostics-dbs.csv', row.names=FALSE)
