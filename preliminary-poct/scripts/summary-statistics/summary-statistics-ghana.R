...
# read.csv('data/ghana/phase_0/raw/prelims.csv') %>%
#   as_tibble() %>% dates() -> data_gh

# read.csv('data/zim_zam/phase_0/raw/standardize/zim-zam-standard.csv') %>%
#   as_tibble() %>% dates() -> data_gh


# Define the function to get the number of rows and columns and export to a text file
creating_summary_statistics <- function(data) {
...
creating_summary_statistics(data_gh)
